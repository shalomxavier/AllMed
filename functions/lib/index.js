...
exports.syncMessageStatuses = exports.onNewMessage = exports.webhook = exports.markConversationRead = exports.getMessages = exports.getConversations = exports.sendWhatsAppMessage = void 0;
...
exports.sendWhatsAppMessage = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        const response = await axios_1.default.post(`https://graph.facebook.com/${WHATSAPP_API_VERSION}/${WHATSAPP_PHONE_NUMBER_ID}/messages`, payload, {
            headers: {
 ...
 */
exports.syncMessageStatuses = functions.pubsub
